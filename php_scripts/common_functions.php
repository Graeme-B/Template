...
/* -------------------------------------------------------------------------------------------- */
/* Function to set up and send the authorisation code to a cellphone                            */
/* -------------------------------------------------------------------------------------------- */
function sendAuthCode($userid, $adminUser, $email, $telephoneNo, &$result)
{
   ...
   $_SESSION['two_phase_admin']  = $adminUser;
   $_SESSION['two_phase_email']  = $email;
   $_SESSION['two_phase_tel_no'] = $telephoneNo;
