...
// Constants
   ...
   define('TWO_PHASE_TIMEOUT',600);
   define('ROOT_PATH','rhianna');
   define('LOGGING_DIRECTORY',CONFIG_HOMEDIR."/rhianna_logs/");
...
// Returned errors
   ...
   define('INVALID_AUTH_CODE',     'InvalidAuthCode');
   define('AUTH_CODE_TIMEOUT',     'AuthCodeTimeout');
   define('NO_AUTH_IN_PROGRESS',   'AuthNotInProgress');
