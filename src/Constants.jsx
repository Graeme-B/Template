...
export const BUSINESS_NAME_LEN        = 256;
export const INDUSTRY_LEN             = 256;
export const PRODUCTS_OR_SERVICES_LEN = 256;
export const TARGET_AUDIENCE_LEN      = 256;
export const FREQUENCY_LEN            = 256;
export const ADMIN_USER_LEN           = 1;
export const TWO_PHASE_LEN            = 1;
export const ACCOUNT_INACTIVE_LEN     = 1;
export const TO_BE_ACTIVATED_LEN      = 1;
